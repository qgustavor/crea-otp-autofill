/**
 * Setup wizard shown when auto-fill isn't configured yet for an email
 * pattern. Walks the user through creating (or linking) the Apps Script
 * that will serve OTP codes back to us.
 */
